...
\newcommand{\nazevcz}{Vývoj QGIS zásuvného modulu pro potřeby analýzy odtokových poměrů metodou SCS-CN}    % český název práce (přesně podle zadání!)
\newcommand{\nazeven}{Development of a QGIS plugin for runoff analysis using the SCS-CN method}          % anglický název práce (přesně podle zadání!)
